...
; CHECK-NEXT:    ret void
;
; CHECK-INLINE-LABEL: @test_memset(
...
; CHECK-INLINE-NEXT:    call void @llvm.memset.p0.i64(ptr align 8 [[TMP4]], i8 0, i64 800, i1 false)
; CHECK-INLINE-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[A]], i8 0, i64 100, i1 false)
; CHECK-INLINE-NEXT:    ret void
;
; CHECK-OUTLINE-LABEL: @test_memset(
...
; CHECK-OUTLINE-NEXT:    call void @__tysan_instrument_mem_inst(ptr [[A:%.*]], ptr null, i64 100, i1 false)
; CHECK-OUTLINE-NEXT:    call void @llvm.memset.p0.i64(ptr align 1 [[A]], i8 0, i64 100, i1 false)
